      ...
      <footer id="contact" className="contact">
        <div className="container">
          ...
          <div className="footer-copyright">
            <div className="row">
              <div className="footer-copyright_left">
                <div className="col-sm-6">
                  <p>
                    &copy; copyright.designed and deve
                    <a href="https://www.themesine.com/">Upasana Bharti</a>.
                  </p>
                </div>
              </div>
              <div className="footer-copyright_right">
                <div className="col-sm-6">
